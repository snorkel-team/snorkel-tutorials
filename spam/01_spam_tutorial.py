...
# For example, let's take a look at 3 random false negatives from the `dev` set, which might inspire some more LFs that vote `SPAM`.
...
df_fn_dev.sample(3, random_state=3)
