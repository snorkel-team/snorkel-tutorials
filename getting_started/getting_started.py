...
# For more detailed versions of the sections in this walkthrough, see the corresponding tutorials: ([Spam LFs](http://snorkel.org/use-cases/01-spam-tutorial), [Spam TFs](http://snorkel.org/use-cases/02-spam-tutorial), [Spam SFs](http://snorkel.org/use-cases/03-spam-tutorial)).
...
#
# An increasingly popular and critical technique in modern machine learning is [data augmentation](https://hazyresearch.github.io/snorkel/blog/tanda.html), the strategy of artificially *augmenting* existing labeled training datasets by creating transformed copies of the data points.
...
# For more detail, see the [Spam TFs tutorial](http://snorkel.org/use-cases/02-spam-tutorial).
...
# For a walkthrough of these steps, see the [Spam SFs tutorial](http://snorkel.org/use-cases/03-spam-tutorial).
...
# Next, to learn more about Snorkel, check out the [tutorials](http://snorkel.org/use-cases/), [resources](http://snorkel.org/use-cases/resources), and [documentation](https://snorkel.readthedocs.io) for much more on how to use Snorkel to power your own machine learning applications.
