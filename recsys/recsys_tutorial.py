...
interactions = load_data(f"data/goodreads_interactions{book_suffix}.json.gz", None, dict(book_id=filt_book_ids))
...
user_author_ratings = data_train.merge(
